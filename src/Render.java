...
public class Render {
    ...
    public void renderMap(Mappa mappa) {
        int rectSize = 80; // Dimensione del rettangolo nero
        int borderSize = 75; // Dimensione del rettangolo rosso
        int offset = (rectSize - borderSize) / 2; // Offset per centrare il rettangolo rosso
    ...
    public void renderMenu() {
        ...
        // Calcoli delle posizioni del testo
